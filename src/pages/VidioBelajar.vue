<template>
    <div>
        <Navbar/>
        <div class="px-5 pt-5 pb-5  md:px-10 md:pt-10 md:pb-8 lg:px-28 lg:pt-12 lg:pb-8">
            <h3 class="text-xs lg:text-2xl font-medium">Jelajahi modulnya dan ubah masa depanmu</h3>
            <form @submit.prevent="handleSearch" class="input input-bordered flex justify-between items-center mt-10">
            <input type="text" placeholder="search" class="w-11/12 focus:outline-none" v-model="param.search">
